const steps = [
    {
        ...
        notificationMessage:'<div class="rate-container"><span>Over 100,000 Reviews</span> <i class="material-icons">star</i> <i class="material-icons">star</i> <i class="material-icons">star</i> <i class="material-icons">star_half</i></div><div class="confirm-label">Confirm Your Email Address Below. You Can Unsubscribe at Anytime</div>', 
    ...
    },
    {
        ...
        title: 'Find Senior Living Options in Your Local Area', 
        className:'purple-notification second-step',
    ...
    },
    {
        ...
        title: 'Find Senior Living Options in Your Local Area', 
        className:'purple-notification third-step',
